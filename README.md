...
8. Finally, `generate_data`, `marmousi`, `wavenet` and `autoencoder` contain Jupyter Notebooks which carry out analysis of our results and will reproduce the results plots in the Solid Earth paper.
